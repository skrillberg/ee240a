#!/bin/ksh
# This script was generated Sun Feb 28 16:28:44 2016 by:
#
# Program: /share/instsww/cadence/ASSURA41-615/tools/assura/bin/64bit/RCXspice
# Version: 3.1.5
# Created: Wed Dec 8 11:40:37 EST 2004
#
#/share/instsww/cadence/ASSURA41-615/tools/assura/bin/64bit/RCXspice -techdir \
#	/share/instsww/cadence/GPDK_PKG/gpdk090_v4.6/assura/rcx -newlvs \
#	/home/aa/users/bkilberg/ee240/inverter.xcn -assura_run_dir \
#	/home/aa/users/bkilberg/ee240/ -assura_run_name inverter -rcxdir \
#	/home/aa/users/bkilberg/ee240/inverter -xy_coordinates c,r -type full \
...
#	/home/aa/users/bkilberg/ee240/inverter/extview.tmp -net_name_space \
#	schematic -minR 0.001 -max_merged_via_size auto -max_fracture_length \
#	infinite -macro_cell -hierarchy_delimiter / -ground_nets_file \
#	/home/aa/users/bkilberg/ee240/rcx.gndNets.nets -fracture_length_units \
#	microns -df2 -cap_models no -cap_ground gnd! -cap_extract_mode \
#	decoupled -cap_coupling_factor 1.0 -array_vias_spacing auto -extract \
#	both -xref \
#	/home/aa/users/bkilberg/ee240/inverter.gnx,/home/aa/users/bkilberg/ee240/inverter.gdx
set -e
set -v
##=======================================================
##ADD_EXPLICIT_VIAS=N
